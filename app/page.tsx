  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f7] font-sans selection:bg-[#fcc200]/30">
      ...
      <div className="overflow-x-hidden">
        ...
        <main className="p-4 sm:p-6 md:p-20 max-w-7xl mx-auto">
          <FadeInUp delay={0.2}>
            <div className="flex items-center gap-3 sm:gap-4 mb-10 sm:mb-16">
              <div className="w-1.5 h-8 bg-[#fcc200] rounded-full"></div>
              <h2 className="text-xl sm:text-2xl font-black uppercase italic tracking-tighter text-white">Clubes Oficiales</h2>
            </div>
          </FadeInUp>
          ...
          <section className="mt-20 md:mt-40 mb-14 md:mb-20 relative px-0 sm:px-4">
            <FadeInUp delay={0.1}>
              <div className="max-w-5xl mx-auto bg-linear-to-b from-[#141414] to-[#0a0a0a] border border-white/5 rounded-[2.3rem] sm:rounded-[3.5rem] p-6 sm:p-12 md:p-20 text-center shadow-2xl relative overflow-hidden group">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-black uppercase italic mb-5 sm:mb-6 tracking-tighter">¿Lideras un <span className="text-[#fcc200]">Club?</span></h2>
                <p className="text-zinc-500 mb-8 sm:mb-12 max-w-lg mx-auto font-medium text-sm sm:text-base md:text-lg leading-relaxed">
                  Gestiona tu plantilla, analiza estadísticas y confirma tu alineación desde el vestidor oficial.
                </p>
                <Link href="/login" className="inline-block w-full md:w-auto bg-white text-black font-black uppercase italic tracking-[0.14em] sm:tracking-[0.2em] px-8 sm:px-12 py-4 sm:py-5 rounded-2xl hover:bg-[#fcc200] hover:scale-105 transition-all shadow-xl shadow-black text-sm sm:text-base">
                  Entrar al Vestidor
                </Link>
              </div>
            </FadeInUp>
